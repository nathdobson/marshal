...
use crate::decode::full::{BinSpecDecoder, BinDecoder};
use crate::encode::full::{BinSpecEncoder, BinEncoder};
...
macro_rules! bin_object {
    ($carrier:path) => {
        const _ : () = {
            ...
            impl $crate::reexports::marshal_object::de::DeserializeVariantForDiscriminant<$crate::decode::full::BinDecoder> for $carrier {
                fn deserialize_variant<'p, 'de>(
                    disc: usize,
                    d: $crate::reexports::marshal::decode::AnySpecDecoder<'p, 'de, $crate::decode::full::BinSpecDecoder<'de>>,
            ...
            impl $crate::reexports::marshal_object::ser::SerializeVariantForDiscriminant<$crate::encode::full::BinEncoder> for $carrier {
                fn serialize_variant<'w,'en>(
                    ...
                    disc: usize,
                    e: $crate::reexports::marshal::encode::AnyEncoder<'w,'en,$crate::encode::full::BinEncoder>,
                    mut ctx: $crate::reexports::marshal::context::Context
